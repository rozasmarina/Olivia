...
place_names = ['Trabuca', 'Benzina', 'Ginteria', 'Tetto Rooftop', 'Tatu Bola',
               ...
               'Das', 'Noname', 'Astor', 'KAIA Bar & Cozinha', 'Cama de Gato',
               'Villa Country', 'D.EDGE', 'Lions Nightclub', 'Beco 203', 'Sputnik Bar',
               'Tokyo', 'Alberta #3', 'Bubu Lounge', 'Club Hotel Cambridge', 'Fortunato Bar',
               'Olívio Bar e Gastronomia', 'Sylvester Bar', 'Skull bar', 'High Line Bar', 'The Blue Pub']
...
place_addresses = ['Avenida Presidente Juscelino Kubitschek, 1444, São Paulo',
                   ...
                   'Rua Fortunato, 133 - Vila Buarque, São Paulo - SP, 01224-030',
                   'Rua dos Pinheiros, 585 - Pinheiros, São Paulo - SP, 05422-011',
                   'Rua Delfina, 163 - Vila Madalena, São Paulo - SP, 05443-010',
                   'Rua Marquês de Itu, 413 - Vila Buarque, São Paulo - SP, 01223-001',
                   'Rua Amaral Gurgel, 453 - Vila Buarque, São Paulo - SP, 01221-001',
                   'Avenida Francisco Matarazzo, 774 - Água Branca, São Paulo - SP, 05001-000',
                   'Avenida Auro Soares de Moura Andrade, 141 - Barra Funda, São Paulo - SP, 01155-050',
                   'Avenida Brigadeiro Luís Antônio, 277 - 1º Andar - República, São Paulo - SP, 01317-000',
                   'Rua Augusta, 609 - Consolação, São Paulo - SP, 01305-000',
                   'Largo do Arouche, 330 - República, São Paulo - SP, 01219-010',
                   'Rua Major Sertório, 110 - Vila Buarque, São Paulo - SP, 01222-000',
                   'Avenida São Luís, 272 - República, São Paulo - SP, 01046-000',
                   'Rua dos Pinheiros, 791 - Pinheiros, São Paulo - SP, 05422-011',
                   'Rua Álvaro de Carvalho, 35 - Centro Histórico de São Paulo, São Paulo - SP, 01050-070',
                   'Rua Joaquim Távora, 1356 - Vila Mariana, São Paulo - SP, 04015-013',
                   'Rua Delfina, 196 - Vila Madalena, São Paulo - SP, 05443-010',
                   'Rua Maria Carolina, 745 - Jardim Paulistano, São Paulo - SP, 03178-200',
                   'Rua Amauri, 244 - Itaim Bibi, São Paulo - SP, 01448-000',
                   'Rua Girassol, 144 - Vila Madalena, São Paulo - SP, 05433-001',
                   'Alameda Ribeirão Preto, 384 - Bela Vista, São Paulo - SP, 01331-000']
...
place_photos = ['https://lh5.googleusercontent.com/p/AF1QipPVj5EVhMNh1BggxUpyddSdbf0Dia0ET2AEioIE=w416-h240-k-no',
                ...
                'https://lh5.googleusercontent.com/p/AF1QipO9Pc91MTL6gSV1yluBNFg6wYhoOjQrCaRAMweU=w426-h240-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipMaRQ2gHeSVJuR4dfCNbKEfRbM9_a9YAyixEwGw=w408-h270-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipP4ceWa688UFz6hs7TeujoOeMCYTP_zurh82YbU=w408-h272-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipMl3boCZkgCmo73wFL9vgUMR6WqF72pYmXz7zTD=w408-h612-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipNWJ3aVFohG6pd2KVCrQ4lKu8jHmX2qnpWhv_-i=w426-h240-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipPP2YpQk0UCO7uG5COpiFeVTosVhD6_uJuKaqBE=w426-h240-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipM5uB23atVEq1Mkr8meDvJ-oFZuLpM3rwO_YGrI=w408-h306-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipN6dA-YQnjfG1a2AgpX_STs925zQwDvy-GHKsD_=w408-h272-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipM91HJo61yrJZJLRhHS5bxmKYRuabr4Z54stGV8=w426-h240-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipNfjldgWolWY0Rp8d7W4NSI-NeMBh8y71n0foUj=w426-h240-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipNNG5O_TxeVForVetQdmTSWpYJSSQIFU9XcLDAM=w408-h306-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipNeWkHpRmweSLjCxO54e-XDyuCvk7Hd1wEq53zR=w408-h544-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipOtHAT2iJZy7SMWJFOj9CW-CAcVAx6H5p-GJV3_=w493-h240-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipNT6NwUolBrNhaAVWschxu68RudAUtgq6ugXZ2P=w408-h306-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipMcMD-xSsKf3_o_joU_9pKhGqSq589g-XjiTa0y=w649-h240-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipPiNXyksNOlbue2d8f26dkLinetGdQSz5CEJBUD=w408-h408-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipOnzy4wjbbGbDDPRwWsA1K3mdExc0hNm5Yb7SXG=w408-h306-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipOWe24gO29d3-OI_yW0J7ugu79KJ10fP7-Bn_P-=w408-h306-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipNIfeQcJu2wOmNeShp6oFhwNwYlZwHxz1chKHUR=w408-h268-k-no',
                'https://lh5.googleusercontent.com/p/AF1QipPXpqNrlWGipj-CYTEd1m2V4QW2oZSOmks0BDMo=w408-h271-k-no']
...
place_descriptions = ['Almoço e happy hour estendido com DJs ,pista de dança e clima animado, em espaço de decoração moderna e retrô.',
                      ...
                      'Ambiente acolhedor e descolado. Atendimento atencioso feito por mulheres incríveis. Possui uma lojinha super legal que tem desde camisetas à produtos eróticos.',
                      'Um dos melhores botecos de São Paulo. Sempre cheio, com gente bonita e comida boa.',
                      'Bar aconchegante com clima retrô-moderno, conhecido por seus drinques, cervejas, lanches e sanduíches gourmet.',
                      'Ponto gastronômico estilizado serve hambúrgueres e variedades apuradas em espaço convidativo com mesas lounge.',
                      'Coquetéis clássicos e criativos, além de petiscos, em espaço boêmio e descontraído com mesa de pingue-pongue.',
                      'Espaço temático do Velho Oeste americano com restaurante, bar, boate, lojas e mais, em casas de madeira.',
                      'Casa noturna que aprimora a experiência sensorial com iluminação elaborada, design e os hits do momento.',
                      'Moderna casa noturna de música eletrônica com pista de dança e lounge confortável.',
                      'Balada com público mix em espaço eletrônico animado por bandas locais ao vivo com noites especiais e open bar.',
                      'Vivam a experiência Sputnik! Eu entrei sem esperar muito, não estava entendendo se era um bar, balada, restaurante, mas tudo faz sentido lá dentro.',
                      'Prédio modernista com diversas atrações, incluindo karaokê, pista de dança e bar, além de exposições e cinema.',
                      'Casa noturna de rock acústico em ambiente intimista com pouca iluminação e ambiente cosmopolita.',
                      'Casa noturna LGBTQ moderna com som e iluminação de alta tecnologia em vários ambientes espaçosos.',
                      'Edifício com arquitetura e decoração inspiradas na São Paulo da virada do século. Ideal para eventos privados.',
                      'Bar aconchegante e sofisticado com aperitivos e drinques coloridos servidos em taças e copos modernos.',
                      'Petiscos, sandubas e pratos contemporâneos, além de drinques criativos, em bar sofisticado com toque natural.',
                      'Drinques especiais, bem diferentes,  bons e baratos, também servem pratos saborosos.',
                      'Casa noturna alegre e informal para shows de rock, blues e música indie com grafite na fachada.',
                      'Gastrobar fino com pátio tem coquetéis, pratos individuais e petiscos elaborados, entre temas de Nova Iorque.',
                      'Ambiente agradável e simples com partidas de futebol em telonas acompanhadas de cerveja e porções.']
